...
KNOWN_ROUTES = {
    ...
    "100": ("Pettah - Panadura",         "පිටකොටුව - පානදුර",       "புறக்கோட்டை - பாணந்துறை",     "Private", "Normal"),
    "101": ("Pettah - Moratuwa",         "පිටකොටුව - මොරටුව",       "புறக்கோட்டை - மொரட்டுவ",      "Private", "Normal"),
    "103": ("Narahenpita - Fort",        "නාරාහේන්පිට - කොටුව",    "நாரஹேன்பிட்ட - கோட்டை",    "Private", "Normal"),
    "119": ("Dehiwala - Maharagama",      "දෙහිවල - මහරගම",         "தெஹிவளை - மகரகம",           "Private", "Normal"),
    "120": ("Pettah - Horana",           "පිටකොටුව - හොරණ",         "புறக்கோட்டை - ஹொரணை",         "Private", "Normal"),
    "122": ("Pettah - Avissawella",      "පිටකොටුව - අවිස්සාවේල්ල", "புறக்கோட்டை - அவிசாவளை",      "Private", "Normal"),
    "125": ("Pettah - Padukka",          "පිටකොටුව - පාදුක්ක",      "புறக்கோட்டை - பாதுக்கா",      "Private", "Normal"),
    "135": ("Kohuwala - Kelaniya",       "කොහුවල - කැලණිය",        "கொஹுவளை - கெலனியா",         "Private", "Normal"),
    "138": ("Pettah - Kottawa",          "පිටකොටුව - කොට්ටාව",      "புறக்கோட்டை - கொட்டாவை",      "Private", "Normal"),
